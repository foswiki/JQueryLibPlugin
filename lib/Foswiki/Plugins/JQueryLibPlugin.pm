...
our $SHORTDESCRIPTION = 'Provides you with the jQuery javascript library';
...
sub initPlugin {
    ...
    # like this:
    # $Foswiki::cfg{Plugins}{JQueryLibPlugin}{ExampleSetting} = 1;
...
1;
__END__
This copyright information applies to the JQueryLibPlugin:

# Plugin for Foswiki - The Free and Open Source Wiki, http://foswiki.org/
#
# JQueryLibPlugin is # This program is distributed in the hope that it will be useful,
# but WITHOUT ANY WARRANTY; without even the implied warranty of
